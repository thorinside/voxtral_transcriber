...
print("Running VoxtralMini Unit Tests")
print("==============================")
print("")

// First, run the Live Transcription to History Test
print("1. Running LiveTranscriptionToHistoryTest...")
print("--------------------------------------------")

import Foundation

// Include the test code directly
...
if testPassed {
    print("🎉 The final chunk transcription and deduplication system works perfectly!")
    print("   Users will see identical, complete transcriptions in both live view and history.")
} else {
    print("❌ The system has issues that need to be fixed.")
}